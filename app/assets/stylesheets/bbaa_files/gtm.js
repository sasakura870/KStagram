...
var Wc=/['()]/g,Xc=function(a){return"%"+a.charCodeAt(0).toString(16)};Gc[12]=function(a){var b=
...
function Af(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.s[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Gd={},S=null,Cf=Math.random();Gd.w="GTM-TZPTKRR";Gd.Gb="3i0";var Df={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Ef="www.googletagmanager.com/gtm.js";var Ff=Ef,Gf=null,Hf=null,If=null,Jf="//www.googletagmanager.com/a?id="+Gd.w+"&cv=52",Kf={},Lf={},Mf=function(){var a=S.sequence||0;S.sequence=a+1;return a};var Nf={},Of=function(a,b){Nf[a]=Nf[a]||[];Nf[a][b]=!0},Pf=function(a){for(var b=[],c=Nf[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
case "event":dl(this,c.a[1],c.a[0],c)}this.a.shift()}};var el=function(a,b){G(this.getName(),["toPath:!string","fromPath:!string"],arguments);Ae(this,"access_globals","write",a);Ae(this,"access_globals","read",b);var c=a.split("."),d=b.split("."),e=Xa(c),f=Xa(d);if(void 0===e||void 0===f)return!1;e[c[c.length-1]]=f[d[d.length-1]];return!0};var fl=function(a,b){var c;G(this.getName(),["path:!string"],[a]);Ae(this,"access_globals","execute",a);for(var d=a.split("."),e=F,f=e[d[0]],h=1;f&&h<d.length;h++)e=f,f=f[d[h]];if("function"!==hb(f))return;for(var k=[],l=1;l<arguments.length;l++)k.push(ob(arguments[l],this.i));c=nb((0,this.i.S)(f,e,k),this.i);return c};var gl=function(a){};var hl=function(a){var b;G(this.getName(),["path:!string"],arguments);Ae(this,"access_globals","read",a);var c=a.split("."),d=F,e;for(e=0;e<c.length-1;e++)if(d=d[c[e]],null==d)return;b=d[c[e]];return nb(b,this.i)};var il=function(a,b){var c=null;G(this.getName(),["functionPath:!string","arrayPath:!string"],arguments);Ae(this,"access_globals","readwrite",a);Ae(this,"access_globals","readwrite",b);var d=a.split("."),e=Xa(d),f=d[d.length-1];if(void 0===e)throw Error("Path "+a+" does not exist.");var h=e[f];if(h&&!Ea(h))return null;if(h)return nb(h,this.i);var k;h=function(){if(!Ea(k.push))throw Error("Object at "+b+" in window is not an array.");k.push.call(k,
arguments)};e[f]=h;var l=b.split("."),m=Xa(l),n=l[l.length-1];if(void 0===m)throw Error("Path "+l+" does not exist.");k=m[n];void 0===k&&(k=[],m[n]=k);c=function(){h.apply(h,Array.prototype.slice.call(arguments,0))};return nb(c,this.i)};var jl=function(a){var b;G(this.getName(),["path:!string"],arguments);Ae(this,"access_globals","readwrite",a);var c=a.split("."),d=Xa(c),e=c[c.length-1];if(void 0===d)throw Error("Path "+a+" does not exist.");var f=d[e];void 0===f&&(f=[],d[e]=f);b=function(){if(!Ea(f.push))throw Error("Object at "+a+" in window is not an array.");f.push.apply(f,Array.prototype.slice.call(arguments,0))};return nb(b,
this.i)};var kl=function(a){var b;return b};var ll=function(a,b){b=void 0===b?!0:b;var c;return c};var ml=function(a,b){var c;return c};var nl=function(a,b){var c;return c};var ol=function(a){var b="";return b};var pl=function(a){var b="";return b};var ql=function(a,b){};var rl={},sl=function(a,b,c,d){G(this.getName(),["url:!string","onSuccess:?Fn","onFailure:?Fn","cacheToken:?string"],arguments);Ae(this,"inject_script",a);var e=this.i,f=function(){b instanceof $a&&b.Ba(e)},h=function(){c instanceof $a&&c.Ba(e)};if(!d){Qe(a,f,h);return}var k=d;rl[k]?(rl[k].onSuccess.push(f),rl[k].onFailure.push(h)):(rl[k]={onSuccess:[f],onFailure:[h]},f=function(){for(var l=rl[k].onSuccess,m=0;m<l.length;m++)M(l[m]);l.push=function(n){M(n);
return 0}},h=function(){for(var l=rl[k].onFailure,m=0;m<l.length;m++)M(l[m]);rl[k]=null},Qe(a,f,h));};var tl=function(){return!1},ul={getItem:function(a){var b=null;return b},setItem:function(a,
b){return!1},removeItem:function(a){}};var vl=function(){try{Ae(this,"logging")}catch(c){return}if(!console)return;for(var a=Array.prototype.slice.call(arguments,0),b=0;b<a.length;b++)a[b]=ob(a[b],this.i);console.log.apply(console,a);};var wl=function(a,b){var c=!1;return c};var xl=function(a,b,c){};var yl=function(a,b,c,d){var e=this;d=void 0===d?!0:d;var f=!1;return f};var zl=function(a,b,c){G(this.getName(),["path:!string","value:?*","overrideExisting:?boolean"],arguments);Ae(this,"access_globals","readwrite",a);var d=a.split("."),e=F,f;for(f=0;f<d.length-1;f++)if(e=e[d[f]],void 0===e)return!1;if(void 0===e[d[f]]||c)return e[d[f]]=ob(b,this.i),!0;return!1};var Al=function(a){for(var b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);128>e?b[c++]=e:(2048>e?b[c++]=e>>6|192:(55296==(e&64512)&&d+1<a.length&&56320==(a.charCodeAt(d+1)&64512)?(e=65536+((e&1023)<<10)+(a.charCodeAt(++d)&1023),b[c++]=e>>18|240,b[c++]=e>>12&63|128):b[c++]=e>>12|224,b[c++]=e>>6&63|128),b[c++]=e&63|128)}return b};var Bl=function(a,b,c){var d=this;};var Cl=function(a){var b;return b};function Dl(a){}
...
function Kl(a){void 0!==a&&D(a,function(b,c){for(var d=0;d<c.length;d++){var e=c[d].replace(/^_*/,"");Lf[e]=Lf[e]||[];Lf[e].push(b)}})};var Ll=["GP","G"],Ml="G".split(/,/);Ml.push("HA");var Nl=!1;Nl=!0;var Ol=null,Pl={},Ql={},Rl;function Sl(a,b){var c={event:a};b&&(c.eventModel=I(b),b[Q.Ac]&&(c.eventCallback=b[Q.Ac]),b[Q.Bb]&&(c.eventTimeout=b[Q.Bb]));return c}
...
cc:b.vtp_useImageTag?void 0:b.vtp_url,protocol:"",kd:void 0,mc:!b.vtp_useImageTag,sessionId:b.vtp_sessionId,uc:b.vtp_transactionVariable,transactionId:void 0,vc:b.vtp_userVariable,rd:d};if(b.vtp_enableAttribution){var f=b.vtp_attributionFields||[];if(f.length){V("//www.gstatic.com/attribution/collection/attributiontools.js",function(){a(e,X("google_attr").build([jo(f,"key","value")||{}]))},b.vtp_gtmOnFailure);return}}a(e)})}();Z.b.c=["google"],function(){(function(a){Z.__c=a;Z.__c.g="c";Z.__c.h=!0;Z.__c.priorityOverride=0})(function(a){return a.vtp_value})}();
...
Z.b.f=["google"],function(){(function(a){Z.__f=a;Z.__f.g="f";Z.__f.h=!0;Z.__f.priorityOverride=0})(function(a){var b=un("gtm.referrer",1)||J.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?Fh(Hh(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):tn(String(b)):String(b)})}();Z.b.k=["google"],function(){(function(a){Z.__k=a;Z.__k.g="k";Z.__k.h=!0;Z.__k.priorityOverride=0})(function(a){return xn(a.vtp_name,un("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
x("set",P+za,L[za])},z=function(){var P=function(Xp,ck,Yp){if(!jb(ck))return!1;for(var xd=Sa(Object(ck),Yp,[]),Mg=0;xd&&Mg<xd.length;Mg++)x(Xp,xd[Mg]);return!!xd&&0<xd.length},L;if(d.vtp_useEcommerceDataLayer){var za=!1;za||(L=un("ecommerce",1))}else d.vtp_ecommerceMacroData&&
...
lb=0;lb<Ka.length;lb++){var wb=L[Ka[lb]];if(wb){P("ec:addProduct",wb,"products");x("ec:setAction",Ka[lb],wb.actionField);if(gg)for(var Kb=0;Kb<kb.length;Kb++){var Lc=L[kb[Kb]];if(Lc){Lc!==wb&&Of("GTM",13);break}}break}}},A=function(P,L,za){var Vb=0;if(P)for(var Ka in P)if(P.hasOwnProperty(Ka)&&(za&&v[Ka]||!za&&void 0===v[Ka])){var kb=w[Ka]?Oa(P[Ka]):P[Ka];"anonymizeIp"!=Ka||kb||(kb=void 0);L[Ka]=kb;Vb++}return Vb},E={name:u};A(f,
...
Z.b.gas=["google"],function(){(function(a){Z.__gas=a;Z.__gas.g="gas";Z.__gas.h=!0;Z.__gas.priorityOverride=0})(function(a){var b=I(a),c=b;c[rd.xa]=null;c[rd.bf]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();
...
Z.b.bzi=["nonGoogleScripts"],function(){(function(a){Z.__bzi=a;Z.__bzi.g="bzi";Z.__bzi.h=!0;Z.__bzi.priorityOverride=0})(function(a){F._linkedin_data_partner_id=a.vtp_id;V("https://snap.licdn.com/li.lms-analytics/insight.min.js",a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)})}();
...
function(){var k=eo(X("UET"),{ti:c.vtp_tagId,q:e});F[d]=k;k.push("pageLoad");c.vtp_gtmOnSuccess()},c.vtp_gtmOnFailure),a=!0}catch(k){M(c.vtp_gtmOnFailure)}};Z.__baut=b;Z.__baut.g="baut";Z.__baut.h=!0;Z.__baut.priorityOverride=0}();Z.b.logging=["google"],function(){function a(){return{}}(function(b){Z.__logging=b;Z.__logging.g="logging";Z.__logging.h=!0;Z.__logging.priorityOverride=0})(function(b){var c=b.vtp_environments||"debug",d=b.vtp_createPermissionError;return{assert:function(e){if("all"!==c&&!fo.Gg())throw d(e,{},"Logging is not enabled in all environments");},J:a}})}();Z.b.smm=["google"],function(){(function(a){Z.__smm=a;Z.__smm.g="smm";Z.__smm.h=!0;Z.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=jo(a.vtp_map,"key","value")||{};return c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue})}();
